...
public class AcceptancePart1 {
    ...
    {
        d = g.getGameDices();
        System.out.println("ROW 67: 6 monkeys + 2 swords");
        Dice sword = new Dice("Sword");
        Dice monkey = new Dice("Monkey");
        c = new Card("Coin",1,0);
    ...
    {
        d = g.getGameDices();
        System.out.println("ROW 68: 2 (skull/monkeys/parrot/swords) + Diamond FC");
        Dice skull = new Dice("Skull");
        Dice sword = new Dice("Sword");
        Dice parrot  = new Dice("Parrot");
        Dice monkey = new Dice("Monkey");
    ...
    {
        d = g.getGameDices();
        System.out.println("ROW 69: 2 (monkeys, skulls, swords), 1 diamond, 1 parrot");
        Dice skull = new Dice("Skull");
        Dice sword = new Dice("Sword");
        Dice parrot  = new Dice("Parrot");
        Dice monkey = new Dice("Monkey");
    ...
    {
        d = g.getGameDices();
        System.out.println("ROW 70: 1 skull, 2 coins, 1(monkey/parrot), 3 swords");
        Dice skull = new Dice("Skull");
        Dice sword = new Dice("Sword");
        Dice parrot  = new Dice("Parrot");
        Dice monkey = new Dice("Monkey");
    ...
    {
        d = g.getGameDices();
        System.out.println("ROW 71: 1 skull, 2 coins, 1(monkey/parrot), 3 swords + Diamond FC");
        Dice skull = new Dice("Skull");
        Dice sword = new Dice("Sword");
        Dice parrot  = new Dice("Parrot");
        Dice monkey = new Dice("Monkey");
    ...
    {
        d = g.getGameDices();
        System.out.println("ROW 72: 4 monkeys, 2 coins ,2 skulls");
        Dice coin = new Dice("Coin");
        Dice monkey = new Dice("Monkey");
        Dice skull = new Dice("Skull");
        c = new Card("Coin",1,0);

        d[0]=d[1]=d[2]=d[3] =monkey;
        d[4]=d[5] = skull;
        d[6]=d[7] = coin;
