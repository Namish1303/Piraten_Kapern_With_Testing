Feature: Multiplayer testing
  ...
  Scenario: row130
    ...
    And player 3 has Card "Coin" with value 0 and bonus 0
    And player 3 rolls "Skull,Skull,Monkey,Monkey,Monkey,Monkey,Monkey,Skull" and scores 0
    And game is over and player 1 wins
  ...
  Scenario: row134
    ...
    And player 3 has Card "Captain" with value 0 and bonus 0
    And player 3 rolls "Skull,Skull,Skull,Skull,Skull,Skull,Parrot,Parrot" and scores 0
    And player 1 has Card "Coin" with value 0 and bonus 0
    And player 1 rolls "Monkey,Parrot,Monkey,Parrot,Monkey,Parrot,Monkey,Parrot" and scores 3800
    And player 2 has Card "Captain" with value 0 and bonus 0
    And player 2 rolls "Skull,Skull,Monkey,Monkey,Monkey,Monkey,Monkey,Skull" and scores 0
    And player 3 has Card "Skulls" with value 1 and bonus 0
  ...
  Scenario: row 142
    ...
    And player 3 has Card "Skulls" with value 2 and bonus 0
    And player 3 rolls "Sword,Sword,Sword,Sword,Sword,Sword,Sword,Skull" and scores 0
    And player 1 has Card "Captain" with value 0 and bonus 0
  ...
  Scenario: 147
    ...
    And player 2 rerolls "1" and gets "Parrot,Skull,Skull,Skull,Skull,Skull,Skull,Coin"
    And player 2 rerolls "1,8" and gets "Skull,Skull,Skull,Skull,Skull,Skull,Skull,Skull" and scores 0
    And game is over and player 1 scores 300 , player 2 scores 0 and player 3 scores 0
